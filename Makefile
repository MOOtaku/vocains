...
# Project:  vocains-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile vocains-qt.pro
#############################################################################
...
Makefile: vocains-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile vocains-qt.pro
...
/Users/eze/vocains/build/build.h: FORCE
	cd /Users/eze/vocains; /bin/sh share/genbuild.sh /Users/eze/vocains/build/build.h
